...
namespace
{
    ...
    {
        if (strcmp(componentName, "ControllerComponent") == 0)
        {
            ControllerComponent* controllerComponent = gameObject.AddComponent<ControllerComponent>();
            controllerComponent->DeSerialize(value);
            return true;
        }
        return false;
    }
...
void GameState::Initialize()
{
    ...
    mGameWorld.loadLevel("../../Assets/Templates/Levels/test_levelFinal.json");
}
